...
data class NeedsTo internal constructor(
     ...
     */
    fun to(format: OutputFormat): Complete =
        Complete(
            from = from,
    ...
    fun metadata(
        key: String,
        value: String,
    ): NeedsTo = copy(metadata = metadata + (key to value))
    ...
    fun variable(
        key: String,
        value: String,
    ): NeedsTo = copy(variables = variables + (key to value))
    ...
    fun requestHeader(
        name: String,
        value: String,
    ): NeedsTo = copy(requestHeaders = (requestHeaders ?: emptyMap()) + (name to value))
